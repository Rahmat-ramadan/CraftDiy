<head>
    ...
    <title>Katalog Produk - MINIATUR JEMBATAN BERBAHAN KAYU</title>
    <style>
        body {
        ...
        p {
            color: #666;
            text-align: justify;
            margin-bottom: 15px; /* Spasi bawah untuk paragraf */
        }
        ...
        .summary {
            ...
            box-shadow: 0 0 10px rgba(0, 0, 0, 0.1);
            margin-top: 20px;
            margin-bottom: 20px; /* Spasi bawah untuk summary */
        }
    ...
    <div class="container">
        ...
        <section id="gambar">
            ...
            <div class="gallery">
                ...
                <img src="gambar2.jpg" alt="Miniatur Jembatan 2">
                <img src="gambar3.jpg" alt="Miniatur Jembatan 3">
                <img src="gambar4.jpg" alt="Miniatur Jembatan 4">
